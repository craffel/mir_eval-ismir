...
\textbf{Standard F-measure, Precision, and Recall}, where an estimated pattern is considered correct only if it matches (up to translation) a reference prototype pattern;
