...
\toprule
 \multicolumn{9}{ c }{Beat Tracking} \\
  \cmidrule(lr){1-9}
 F-Measure  &  Cemgil   &   Goto    &    P-score & CMLc     &     CMLt       &   AMLc     &     AMLt    &      D (bits)\\
 0.00659 & 0.00035 & 0.00060  & 0.00877 & 0.00157 & 0.00135 & 0.00137&  0.00135 & 0.10566\\
  \midrule
 \multicolumn{5}{ c }{Chord Recognition} & \multicolumn{4}{ c }{Something else}  \\
  \cmidrule(lr){1-5}
  \cmidrule(lr){6-9}
 Root  &  Maj/Min   &   Maj/Min + Inv    &     Sevenths     &     Sevenths + Inv & CMLt      &   AMLc     &     AMLt    &      D (bits)\\
 ??? & ??? & ???  & ??? & ??? & 0.00135 & 0.00137&  0.00135 & 0.10566\\
% [ 0.00686523,  0.16348339,  1.00519802,  0.48286893,  0.89935441]
  \midrule
 \multicolumn{3}{ c }{Onset Detection} & \multicolumn{6}{ c }{Blah}  \\
  \cmidrule(lr){1-3}
  \cmidrule(lr){4-9}
 F-Measure  &  Precision   &  Recall    &     McKinney P-s & CMLc     &     CMLt       &   AMLc     &     AMLt    &      D (bits)\\
 0.00203 & 0.00202 & 0.00203  & 0.00877 & 0.00157 & 0.00135 & 0.00137&  0.00135 & 0.10566\\
  \bottomrule
