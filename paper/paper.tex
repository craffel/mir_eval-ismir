...
Towards this end, \mireval{} is hosted on Github,\footnote{URL redacted} which provides a straightforward way of proposing changes and additions to the codebase using the Pull Request feature.
...
The authors would like to thank (name redacted) for helpful advice about comparing chord labels.
