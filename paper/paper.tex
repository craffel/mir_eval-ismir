...
% ------
\title{\mireval{}: A Transparent Codebase for Evaluating MIR}
...
When the scores reported by \mireval{} differ substantially from the reference, we diagnose the differences in implementation.
