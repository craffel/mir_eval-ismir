...
Melody extraction, or predominant fundamental frequency ($f_0$) estimation,
involves the estimation of the pitch ($f_0$) sequence of the melody from a
polyphonic music recording \cite{salamon:MelodyReview:IEEESPM13}.
