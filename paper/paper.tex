...
However, Colins\cite{TomColins2013} put together all the available metrics for this task for the first MIREX edition, which resulted in 21 different scores, each one implemented in MIR eval.
